    ...
    public function up()
    {
        Schema::create('acciones', function (Blueprint $table) {
            ...
            $table->double('precioventa', 15, 2)->default(0.00)->nullable();
                        $table->double('precioventa2', 15, 2)->default(0.00)->nullable();
            $table->double('precioventa3', 15, 2)->default(0.00)->nullable();;
            $table->double('precioventa4', 15, 2)->default(0.00)->nullable();;
